...
[![Version](https://img.shields.io/badge/version-0.0.7-orange.svg)](.claude-plugin/marketplace.json)
...
| `terraform-code-reviewer` | Terraformコードのセキュリティ・コスト・ベストプラクティスレビュー | `/terraform-code-reviewer` | sonnet |
